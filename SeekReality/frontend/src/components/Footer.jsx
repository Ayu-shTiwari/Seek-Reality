...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white border-t border-gray-800">
      <div className="container max-w-screen mx-auto px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400">
              ...
              Our mission is to combat digital deception and protect online integrity 
          ...
          <div className="border-l border-gray-800 pl-8">
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <span className="w-2 h-2 bg-cyan-400 rounded-full mr-2 group-hover:scale-125 transition-transform"></span>
                  Home
                </Link>
              </li>
              <li>
